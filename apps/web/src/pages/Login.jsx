      ...
      <div className="login-left-panel" style={{ width: "42%", flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px", position: "relative", zIndex: 1 }}>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
            ...
            <span style={{ fontSize: "11px", color: "#374151", fontFamily: "'JetBrains Mono',monospace" }}>System Operational · v{stats.version}</span>
          </div>
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      // Same success state on failure to prevent enumeration.
                      setForgotSuccess(true);
                    } finally {
                      setForgotLoading(false);
                    }
